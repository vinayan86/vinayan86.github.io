...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3  box-shadow " >
      ...
      <nav class="my-2 my-md-0 mr-md-3">
        ...
        <a class="p-2 text-white" href="DriverHome">Home</a>
        ...
        <form class="form-inline my-2 my-lg-0" action="searchlicence" method="post">
      <input class="form-control mr-sm-2" type="search" placeholder="Search By Licesence Plate" name="licence" aria-label="Search">
      <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search </button>
    </form>
    &nbsp;&nbsp;
     <form class="form-inline my-2 my-lg-0" action="searchrating" method="post">
      <select class="form-control mr-sm-2" type="number"  placeholder="" name="rating" aria-label="Search">
